...
if [ "$1" = "--local" ]; then
    java -jar ../lib/jgrade-1.0.0-all.jar -c staff.hello.GradeHello --pretty-print
else
    java -jar ../lib/jgrade-1.0.0-all.jar -c staff.hello.GradeHello -o /autograder/results/results.json
fi
